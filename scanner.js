...
const validator = function (code) {
    ...
    if (code.length === 5 && /^\d+$/.test(code)) {
        ...
        error.innerHTML = "WARNING wrong code format: " + code;
...
function beepNok() {
    let snd = new Audio("data:audio/wav;base64,UklGRl9vT19XQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YU"+Array(1e3).join(123));
    snd.play();
}
